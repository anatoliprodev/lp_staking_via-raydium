...
pub fn process_faucet_usdc_usdr_lp(ctx: Context<FaucetUsdcUsdrLp>,  state_nonce: u8, mint_lp_nonce: u8, user_token_lp_nonce: u8) -> ProgramResult {
    ...
    token::mint_to(cpi_ctx, LP_USDC_USDR_AMOUNT)?;
    Ok(())
}
